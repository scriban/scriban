...
- [`array.add`](array#array.add)
- [`array.add_range`](array#array.add_range)
- [`array.compact`](array#array.compact)
- [`array.concat`](array#array.concat)
- [`array.cycle`](array#array.cycle)
- [`array.any`](array#array.any)
- [`array.each`](array#array.each)
- [`array.filter`](array#array.filter)
- [`array.first`](array#array.first)
- [`array.insert_at`](array#array.insert_at)
- [`array.join`](array#array.join)
- [`array.last`](array#array.last)
- [`array.limit`](array#array.limit)
- [`array.map`](array#array.map)
- [`array.offset`](array#array.offset)
- [`array.remove_at`](array#array.remove_at)
- [`array.reverse`](array#array.reverse)
- [`array.size`](array#array.size)
- [`array.sort`](array#array.sort)
- [`array.uniq`](array#array.uniq)
- [`array.contains`](array#array.contains)
