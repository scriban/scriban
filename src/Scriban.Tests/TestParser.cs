...
namespace Scriban.Tests
{
    ...
    public class TestParser
    {
        ...
        private static string FunctionClear(ScriptExpression what = null) => what?.ToString();
        ...
        [TestCase("3 & 2", 2, "3 & 2")]
        // long
        [TestCase("10000000000 + 1", 10000000000 + 1, "10000000000 + 1")]
        [TestCase("10000000000 - 1", 10000000000 - 1, "10000000000 - 1")]
        [TestCase("10000000000 * 3", 10000000000 * 3, "10000000000 * 3")]
        [TestCase("10000000000 / 3", (double) 10000000000 / 3, "10000000000 / 3")]
        [TestCase("10000000000 // 3", 10000000000 / 3, "10000000000 // 3")]
        [TestCase("10000000000 << 2", 10000000000 << 2, "10000000000 << 2")]
        [TestCase("10000000000 >> 2", 10000000000 >> 2, "10000000000 >> 2")]
        [TestCase("10000000001 | 2", 10000000001 | 2, "10000000001 | 2")]
        [TestCase("10000000003 & 2", 10000000003 & 2, "10000000003 & 2")]
        ...
        [TestCase("4.0f << 1", 4.0f * 2.0f, "4.0f << 1")]
        [TestCase("4.0f >> 1", 4.0f / 2.0f, "4.0f >> 1")]
        ...
        [TestCase("4.0 ^ 2.0", 16.0, "4.0 ^ 2.0")]
        [TestCase("4.0 << 1", 4.0 * 2.0, "4.0 << 1")]
        [TestCase("4.0 >> 1", 4.0 / 2.0, "4.0 >> 1")]
        ...
        public static void AssertTemplate(string expected, string input, ScriptLang lang = ScriptLang.Default, bool isRoundtripTest = false, bool supportExactRoundtrip = true, object model = null,
            bool specialLiquid = false, bool expectParsingErrorForRountrip = false, bool supportRoundTrip = true)
        {
            ...
            while (true)
            {
                var isRoundtrip = roundtripText != null;
                var hasErrors = false;
                ...
                {
                    hasErrors = true;
                    for (var i = 0; i < template.Messages.Count; i++)
                    {
        ...
        public static IEnumerable ListTestFiles(string folder) => ListTestFilesInFolder(folder);
