...
namespace Scriban.Parsing
{
    ...
    record LexerOptions
    {
        ...
        /// </summary>
        public string FrontMatterMarker { get; init; } = DefaultFrontMatterMarker;
        ...
        /// </summary>
        public bool EnableIncludeImplicitString { get; init; }
        ...
        /// </summary>
        public bool KeepTrivia { get; init; }

        /// <summary>
        /// Gets or sets a delegate to allow to match a custom token.
        /// </summary>
        public TryMatchCustomTokenDelegate? TryMatchCustomToken { get; init; }
