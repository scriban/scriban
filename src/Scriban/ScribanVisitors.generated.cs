...
namespace Scriban.Syntax
{
    ...
    public abstract partial class ScriptRewriter
    {
        ...
        public override ScriptNode Visit(ScriptElseStatement node)
        {
            ...
            return new ScriptElseStatement() { ElseKeyword = newElseKeyword, Body = newBody, Else = newElse };
        }
        ...
        public override ScriptNode Visit(ScriptForStatement node)
        {
            ...
            var newBody = (ScriptBlockStatement)Visit((ScriptNode)node.Body);
            return new ScriptForStatement() { ForOrTableRowKeyword = newForOrTableRowKeyword, Variable = newVariable, InKeyword = newInKeyword, Iterator = newIterator, NamedArguments = newNamedArguments, Body = newBody };
        }
        ...
        {
            var newName = (ScriptIdentifier)Visit((ScriptNode)node.Name);
        ...
        public override ScriptNode Visit(ScriptTableRowStatement node)
        {
            ...
            var newNamedArguments = VisitAll(node.NamedArguments);
            var newBody = (ScriptBlockStatement)Visit((ScriptNode)node.Body);
            return new ScriptTableRowStatement() { ForOrTableRowKeyword = newForOrTableRowKeyword, Variable = newVariable, InKeyword = newInKeyword, Iterator = newIterator, NamedArguments = newNamedArguments, Body = newBody };
        }
