...
namespace Scriban.Syntax
{
    ...
    public partial class ScriptConditionalExpression
    {
    ...
    public partial class ScriptEndStatement
    {
        public override int ChildrenCount => 1;
    ...
    public partial class ScriptEscapeStatement
    {
    ...
    public partial class ScriptFrontMatter
    {
        public override int ChildrenCount => 3;
    ...
    public partial class ScriptIdentifier
    {
        public override int ChildrenCount => 0;
    ...
    public partial class ScriptKeyword
    {
        public override int ChildrenCount => 0;
    ...
    public abstract partial class ScriptRewriter
    {
        ...
        public override ScriptNode Visit(ScriptEndStatement node)
        {
            ...
            return new ScriptEndStatement() { EndKeyword = newEndKeyword };
        }
