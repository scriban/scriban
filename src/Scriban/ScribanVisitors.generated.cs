...
namespace Scriban.Syntax
{
    ...
    public abstract partial class ScriptRewriter
    {
        ...
        public override ScriptNode Visit(ScriptForStatement node)
        {
            ...
            return new ScriptForStatement() { ForOrTableRowKeyword = newForOrTableRowKeyword, Variable = newVariable, InKeyword = newInKeyword, Iterator = newIterator, NamedArguments = newNamedArguments, Body = newBody, Else = newElse };
        }
        ...
        public override ScriptNode Visit(ScriptTableRowStatement node)
        {
            ...
            var newBody = (ScriptBlockStatement)Visit((ScriptNode)node.Body);
            var newElse = (ScriptElseStatement)Visit((ScriptNode)node.Else);
            return new ScriptTableRowStatement() { ForOrTableRowKeyword = newForOrTableRowKeyword, Variable = newVariable, InKeyword = newInKeyword, Iterator = newIterator, NamedArguments = newNamedArguments, Body = newBody, Else = newElse };
        }
