...
namespace Scriban.Syntax
{
    ...
    public abstract partial class ScriptRewriter
    {
        ...
        public override ScriptNode Visit(ScriptForStatement node)
        {
            ...
            return new ScriptForStatement() { Body = newBody, ForOrTableRowKeyword = newForOrTableRowKeyword, Variable = newVariable, InKeyword = newInKeyword, Iterator = newIterator, NamedArguments = newNamedArguments };
        }
        ...
        {
            return new ScriptRawStatement() { Text = node.Text, SliceIndex = node.SliceIndex, SliceLength = node.SliceLength, IsEscape = node.IsEscape };
        }
        ...
        public override ScriptNode Visit(ScriptTableRowStatement node)
        {
            ...
            var newIterator = (ScriptExpression)Visit((ScriptNode)node.Iterator);
            var newNamedArguments = VisitAll(node.NamedArguments);
            return new ScriptTableRowStatement() { Body = newBody, ForOrTableRowKeyword = newForOrTableRowKeyword, Variable = newVariable, InKeyword = newInKeyword, Iterator = newIterator, NamedArguments = newNamedArguments };
        }
        ...
        public override ScriptNode Visit(ScriptWhileStatement node)
        {
            ...
            var newCondition = (ScriptExpression)Visit((ScriptNode)node.Condition);
            return new ScriptWhileStatement() { Body = newBody, WhileKeyword = newWhileKeyword, Condition = newCondition };
        }
