...
namespace Scriban.Syntax
{
    ...
    internal partial class ScientificFunctionCallRewriter
    {
        ...
        public async ValueTask<ScriptExpression> RewriteAsync(TemplateContext context)
        {
            _index = 0;
            return await RewriteAsync(context, PrecedenceTopLevel).ConfigureAwait(false);
        }
    }
    ...
    {
        public static async ValueTask<object> CallAsync(TemplateContext context, ScriptNode callerContext, object functionObject, bool processPipeArguments, IList<ScriptExpression> arguments = null)
        {
            ...
            if (arguments != null)
            {
                await ProcessArgumentsAsync(context, callerContext, arguments, function, scriptFunction, argumentValues).ConfigureAwait(false);
            }
        ...
        public override async ValueTask<object> EvaluateAsync(TemplateContext context)
        {
            ...
            return await CallAsync(context, Target, targetFunction, context.AllowPipeArguments, Arguments).ConfigureAwait(false);
        }
        ...
        public async ValueTask<ScriptExpression> GetScientificExpressionAsync(TemplateContext context)
        {
            ...
            if (context.UseScientific && !ExplicitCall && Arguments.Count > 0)
            {
                ...
                return await rewrite.RewriteAsync(context).ConfigureAwait(false);
            }

            return this;
        }

        private static async ValueTask ProcessArgumentsAsync(TemplateContext context, ScriptNode callerContext, IList<ScriptExpression> arguments, IScriptCustomFunction function, ScriptFunction scriptFunction, ScriptArray argumentValues)
        {
                ...
                if (namedArg != null)
                {
                    ...
                    if (scriptFunction != null)
                    {
                        if (function.HasVariableParams)
                        {
                            ...
                            {
                                argumentValues.SetValue(context, callerContext.Span, argName, await context.EvaluateAsync(namedArg).ConfigureAwait(false), false);
                                continue;
                            }
                            else
                            {
    ...
    public partial class ScriptObjectMember
    {
        public override async ValueTask<object> EvaluateAsync(TemplateContext context)
        {
            ...
            context.CurrentGlobal.SetValue(context, Span, name, await context.EvaluateAsync(Value).ConfigureAwait(false), false);
            return null;
        }
    }
