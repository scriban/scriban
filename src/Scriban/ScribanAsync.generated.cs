        ...
        private async ValueTask<ScriptExpression> RewriteAsync(TemplateContext context, int precedence)
        {
            ...
            while (_index < Count)
            {
                ...
                if (nextExpression is ScriptArgumentBinary bin)
                {
                    ...
                    { Left = leftValue, Operator = bin.Operator, OperatorToken = new ScriptToken(bin.Operator.ToText()), Right = rightValue, };
                    continue;
                }
    ...
    public partial class ScriptRawStatement
    {
        public override async ValueTask<object> EvaluateAsync(TemplateContext context)
        {
            ...
            if (SliceLength > 0)
            {
                ...
                {
                    await context.WriteAsync(Text, SliceIndex, SliceLength).ConfigureAwait(false);
                }
                else
                {
