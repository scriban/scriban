...
- Safe parser and safe runtime, allowing you to control what objects and functions are exposed
  - Configurable [string and output limits](https://scriban.github.io/docs/runtime/safe-runtime/#configuring-string-and-output-limits-independently), with independent truncation or exception policies.
